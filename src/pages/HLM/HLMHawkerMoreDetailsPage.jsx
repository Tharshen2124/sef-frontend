  ...
  return (
    ...
    <section className="p-10">
            <div className="mb-5 text-[12px]">
                ...
                <a href={`/hlm/manage-hawker-accounts/${hawkerID}`} className="text-blue-600 hover:underline">More Info</a>
            </div>
            ...
            { user && user.Penalty.map((penalty, index) => (
                <PenaltyCard 
                    key={index}
                    penaltyAmount={penalty.penaltyAmount}
                    violationType={penalty.violationType}
                    createdAt={penalty.created_at}
                    penaltyDocument={penalty.penaltyDocument}
                />
            ))}
    </section>
    </>
